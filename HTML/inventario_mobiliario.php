...
<body>
    ...
    <main class="container my-4">
        <section class="card shadow p-4">
            <h2 class="card__title text-primary mb-4">FORMULARIO - Inventario, Control y Compras</h2>
            ...
            <h2 class="card__title mb-3 mt-4">Registro Control de Inventario</h2>
            ...
            <h2 class="card__title mb-3 mt-4">Detalle de Compra de Mobiliario</h2>

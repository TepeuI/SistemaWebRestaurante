...
document.addEventListener('DOMContentLoaded', function () {
        ...
        if (validarFormulario()) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    text: '¿Deseas registrar este mantenimiento de muebles?',
                    icon: 'question',
                ...
                if (confirm('¿Deseas registrar este mantenimiento de muebles?')) doSubmit();
            }
        }
    });
    ...
    function validarFormulario() {
        ...
        if (!codigo) { 
            showWarning('El código de serie es requerido'); 
            document.getElementById('codigo_serie').focus(); 
            return false; 
        }
        if (!costo || costo < 0) { 

document.addEventListener("DOMContentLoaded", () => {
  ...
  function cargarBitacora(usuario = "", fechaInicio = "", fechaFin = "") {
    ...
    fetch("../bitacora_crud.php", { method: "POST", body: datos })
      .then((r) => r.json())
      .then((res) => {
        ...
        if (res.status === "ok" && res.data.length > 0) {
          ...
          tbody.innerHTML = `<tr><td colspan="6" class="text-muted py-3">No hay registros de bitácora</td></tr>`;
        }
      })
